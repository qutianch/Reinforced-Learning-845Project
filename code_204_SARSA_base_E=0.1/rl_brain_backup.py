...
class agent():
    ...
    def __init__(self, epsilon, lr, gamma, current_stock, debug, expected_stock, model_based):
        ...
        self.actions = [-45,30,10,0,10,30,45]
        self.reward = 0
    ...
    def learn(self, s, a, r, s_, ex, g):
        ...
        if self.debug == True:
            print('rl_brain Debug info-----')
            print("current bike stockc: {}".format(s))
    ...
    def choose_action_fb(self, s, ex):
    ...
    def learn_fb(self, s, a, a_fbn, r, s_, ex, g):
        ...
        if g == False:
            ...
            # Updated Q Target Value if it is not end of day
            q_target = r + self.gamma * self.q_table.loc[s_, a_fbn]  #ADDED BY FB: THIS IS NOW SARSA ALGO
